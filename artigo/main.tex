...
Esse efeito é particularmente evidente no cenário \emph{Invertido}, no qual o pré-processamento produz uma sequência ordenada e o Selection Sort não necessita realizar trocas. Ainda assim, o tempo total apresentou redução de desempenho de $11,8\%$, indicando que a economia das trocas evitadas não compensou o custo adicional do pré-processamento. Também foram observados ganho de $22,1\%$ em \emph{Zigue-zague} e perda de $8,3\%$ em \emph{Duplicados}. Como as medições não separaram comparações, trocas e acessos à memória, não é possível atribuir essas variações a um mecanismo microarquitetural específico. Os resultados, portanto, não contradizem a caracterização teórica do Selection Sort: o número de comparações permanece fixo, enquanto o tempo observado também depende das operações realizadas durante a execução.
